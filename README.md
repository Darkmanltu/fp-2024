...
### changes to lib2 for 3rd lab work

-changed parseQuery to return a string of what is left after parsing the first query as the first return (string, query)

-changed parsing of currency type to be Capatilized on first letter (error on my part shouldve been fixed long time ago (i.e "Gold" and not "gold"))